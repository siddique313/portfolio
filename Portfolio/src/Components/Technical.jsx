      ...
      <>
          <div className='mt-10 px-4 flex flex-col gap-4'>
             ...
             <TechnicalItems width={"75%"} skillName={"Photoshop"}/>
              <div className='mt-3  '>
               <button className='py-3 cursor-pointer px-4 bg-slate-500 text-white hover:bg-slate-300 hover:text-black flex items-center justify-start gap-2'>   <span><FaDownload />
               </span> Download Resume</button>
              </div>
      </div>
      </>
  )
